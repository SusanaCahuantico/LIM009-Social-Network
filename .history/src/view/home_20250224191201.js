...
export default () => {
    ...
    <h2> Bienvenida! </h2>
    <input class="form-control mx-auto p-2" id="emailLogin" style="width: 300px" type="text" placeholder="Email"/> </br>
    <input class="form-control mx-auto p-2" id="contraseñaLogin" style="width: 300px" type="password" placeholder="Password"/> </br>
